...
def test_constructor_switch_sauce(browser):
    ...
    error_input = browser.find_element(By.CSS_SELECTOR, ".input.input_type_password.input_size_default.input_status_error")

    # Сообщение об ошибке
    error_message = browser.find_element(By.CSS_SELECTOR, ".input__error.text_type_main-default")
